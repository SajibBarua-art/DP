...
const double fibonacci_ratio = 1.618034;
...
void Solution(int tc){
    ...
    while(n--) {
        ...
        for(char c: s) {
            if(c == 'a') mark = (mark | 1);
            else if(c == 'e') mark = mark | (1 << 1);
            else if(c == 'i') mark = mark | (1 << 2);
            else if(c == 'o') mark = mark | (1 << 3);
            else if(c == 'u') mark = mark | (1 << 4);
        }
